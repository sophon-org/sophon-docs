...
<Accordion title="When can my SP be redeemed for SOPH?">
  SP from Phase 1 will be calculated and shown within your **Farming Dashboard** once the migration is over. It will be locked until the **Token Generation Event (TGE)** which is scheduled for **End H1 2025**.
</Accordion>
