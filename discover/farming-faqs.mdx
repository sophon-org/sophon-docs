...
<Accordion title="When will farming on Eth L1 end?">
  SP points farming is concluding on 26/12/24. On the 26/12/24 withdrawals from Farming on Ethereum L1 will be suspended in preparation for the migration and launch of Farming on Sophon Mainnet on 27/12/24. If you want to withdraw your assets before the migration on then you need to withdraw before 26/12/24.
</Accordion>
