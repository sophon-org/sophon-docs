...
<Note>Assets that were boosted on Ethereum Mainnet will remain **permanently locked** for liquidity purposes and will no longer be eligible for further boosting on the Sophon Mainnet.</Note>
