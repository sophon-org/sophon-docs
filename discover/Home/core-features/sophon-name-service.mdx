...
Instead of sharing a complex wallet address, people can find you, send you things, and recognize your contributions using a memorable name like [username].[soph.id](http://soph.id).
