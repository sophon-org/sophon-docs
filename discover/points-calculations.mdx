...
- **Total Points Per Block:** 10 SPs
</Tip>

### Pool Value Calculation

```
Pool Value = (Total Tokens Staked × Token Price × Pool Multiplier) ÷ 1e18
```
...
- **Points per Share:** Reward rate per token.
- **Last Updated Block:** Most recent calculation timestamp.
- **Total Staked Tokens:** Including Boosts.
...
```
Pending Points = (Your Stake × Points per Share ÷ 1e18) + Settled Points - Reward Debt
```

Where:

- **Your Stake:** How many tokens you've deposited in a pool.
- **Points per Share:** How many points each token has earned so far.
- **1e18:** This makes sure you get the exact right amount of points.
- **Settled Points:** Points you've earned but haven't claimed yet.
- **Reward Debt:** Points that have already been counted for your stake.
