...
<Warning>Currently, only **ETH transfers** are available on Orbiter Finance.</Warning>
...
5. Your **ETH** will arrive on **Sophon** within approximately **10–20 seconds**, thanks to Orbiter’s efficient bridging mechanism.
...
![Orbiter Details](/images/orbiter-details.png)
