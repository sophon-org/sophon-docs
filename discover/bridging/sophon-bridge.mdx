...
<Warning>
At present, there is a **3 hour waiting period** for transfers out of Sophon. 
For faster bridging, you may use one of the third-party bridges instead.
</Warning>
...
<Tip>[Sophon’s Bridge](https://portal.sophon.xyz/bridge/) supports any **ERC-20 token** from [Ethereum](https://ethereum.org).</Tip>
...
9 - Once your transaction is completed, your assets will be available in your wallet within **24 hours**.

![](/images/bridging/sophon-bridge-9.webp)

<Warning>At present, there is a **24 hour waiting period** for transfers. However, work is underway to reduce the time required to 3 hours which you can read about [here](https://forum.zknation.io/t/zip-2-reduce-the-execution-delay-from-21-hours-to-3-hours/305).</Warning>
