...
## Claiming Your Guardian Membership
...
<Accordion title="Why didn’t my commission reward percentage update in the Guardian Dashboard?">
  Once a commission is set for an operator address, it cannot be modified.
  
  To update your commission, you’ll need to create a new operator address with the desired percentage. Delegators will then need to switch to your new operator address.
</Accordion>
