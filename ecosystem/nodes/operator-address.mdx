...
If the operator address isn't provided within the application, you may need to contact the platform to retrieve this information. Check the current available node as a service providers [here](https://docs.sophon.xyz/nodes/light-nodes#current-node-as-a-service-naas-providers).
...
<Warning>
  If you didn't set a different address to receive your commission rewards, you must have control
  over the operator address to claim your **SOPH** when they are available.
</Warning>
