...
<Note>
  Please see the questions below to resolve any issue(s) you may be facing. If none of these relate to your problem, please contact <a href="mailto:product@sophon.xyz">
  product@sophon.xyz</a>
...
<Accordion title="When will farming on Ethereum L1 end?">
...
<Accordion title="When will Sophon L2 farming end?">
  The farming program ended on **30/06/2025**.
</Accordion>
...
<Accordion title="When can my SP be redeemed for SOPH?">
  SP from Phase 1 will be calculated and shown within your **Farming Dashboard** once the migration is over. It was unlocked on the **Token Generation Event (TGE)** which happened on **May 28th, 2025**.
</Accordion>