...
# Calling `send`
`LzOftHelper` contract: `TODO`

<Note>You will need to contact product@sophon.xyz first to get your OFT token whitelisted on the `LzOftHelper` contract.</Note>
...
const HELPER_ADDRESS = "0x..."; // TODO: Add the actual deployed helper address
...
contract SendOFT is Script {
    ...
    // Helper contract address
    address constant HELPER_ADDRESS = address(0x...); // TODO: Add the actual deployed helper address
