...
- API Endpoint: [https://api-explorer.sophonapi.com/](https://api-explorer.sophonapi.com/)
- Docs: [https://api-explorer.sophon.xyz/docs](https://api-explorer.sophon.xyz/docs)

**Testnet:**
- Site: [https://explorer.testnet.sophon.xyz/](https://explorer.testnet.sophon.xyz/)
- API Endpoint: [https://block-explorer-api.testnet.sophonapi.com/](https://block-explorer-api.testnet.sophonapi.com/)
- Docs: [https://block-explorer-api.testnet.sophon.xyz/docs](https://block-explorer-api.testnet.sophon.xyz/docs)
