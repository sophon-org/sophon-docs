...
A script that shows and validates the configuration (and the approval needed) can be found [here](https://github.com/sophon-org/sophon-oft/blob/main/layerzero.config.ts).