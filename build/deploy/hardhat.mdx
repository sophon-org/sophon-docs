...
- The Paymaster will automatically whitelist your deployed contracts after about 30 seconds
- Wait a few moments after deployment before interacting with newly deployed contracts
- The latest `zksolc` versions 1.5.7 and 1.5.8 are not currently supported for verification on Etherscan