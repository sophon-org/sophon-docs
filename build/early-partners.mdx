...
<Tip>Upon completing the onboarding process, please follow the [Hardhat](/build/interact/hardhat) or [Foundry](/build/interact/foundry) guides to deploy your contracts.</Tip>
