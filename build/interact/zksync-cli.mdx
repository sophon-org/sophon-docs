---
title: 'zksync-cli'
description: 'Learn about how to develop on Sophon using zksync-cli'
---
...
To learn more about the available commands in ZKsync CLI, see the [**CLI reference**](https://docs.zksync.io/zksync-era/tooling/zksync-cli/reference).
