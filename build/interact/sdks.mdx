...
<Note>
  To understand better how to use our Paymaster for contract interactions, expand the detailed **viem & wagmi** explanation right below.
</Note>
  ...
  export default async function sendTransaction(
    ...
    if (chainId === 50104 || chainId === 531050104) {
      const walletClient = createWalletClient({
        chain: chainId === 531050104 ? sophonTestnet : sophonMainnet
