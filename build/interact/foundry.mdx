...
<Tip>
  You can find more info on the official [ZKsync Foundry](https://foundry-book.zksync.io/getting-started/installation) website.
</Tip>
...
<Note>
  A full baseline Foundry example can be found on our GitHub [here](https://github.com/sophon-org/hello-foundry-template).
</Note>
