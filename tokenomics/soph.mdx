...
- Sophon Contract Address (Sophon): **[0x000000000000000000000000000000000000800A](https://sophscan.xyz/token/0x000000000000000000000000000000000000800A)** 
- Sophon Contract Address (Ethereum): **[0x6B7774CB12ed7573a7586E7D0e62a2A563dDd3f0](https://etherscan.io/token/0x6B7774CB12ed7573a7586E7D0e62a2A563dDd3f0)**
...
| Ecosystem Reserve                    | 2,600,000,000 | 25%            | 42% unlocked, remaining 58% subject to a linear vest over 5 years.                                                                                                                                                                               |
...
A continuation of the L1 Farm, the post-mainnet liquidity mining campaign (L2 Farm) has retained liquidity on Sophon whilst we continue to grow. Now, with a strong set of builders and applications on Sophon, and with many more coming, the L2 Farm will end shortly after TGE. These tokens will be subject to a 6 month vesting schedule once claims are made available in the coming months.

The total amount has been reduced from 4% to 2%. This is due to the programme’s duration being reduced as it was originally planned to go on until December 2025. Once governance is implemented, future farms may be proposed, with the funds coming from Ecosystem Reserves.
