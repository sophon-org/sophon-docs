...
As a authentication provider, Sophon Account is able to provide a list of data scopes that the user can grant to the application.
...
The user has the option to grant or not to grant the scopes to the application durint the authentication process.
