...
You can find the deployed and verified Contracts on our chains, you can use our explorers to get more information and interact with them.
Our explorers can be found at:

- Mainnet: https://explorer.sophon.xyz
- Testnet: https://explorer.testnet.sophon.xyz

You can also use our Sophscan to get more information about the contracts:

- Mainnet: https://sophscan.xyz
- Testnet: https://testnet.sophscan.xyz
