...
**Guardians** get **20%** of the **total $SOPH supply**. Half (50%) comes automatically through **Full Node Delegation**. To unlock your complete allocation, also delegate your membership to a **Light Node** - simple path to maximum rewards.
</Warning>
